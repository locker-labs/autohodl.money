                    ...
                    <div className='flex items-center justify-between px-3 py-3.5'>
                      <div className='flex items-center gap-[9px]'>
                        ...
                        <div>
                          <p className='font-semibold text-black text-base text-left'>
                            ${roundOff(formatUnits(BigInt(tx.value ?? 0), getTokenDecimalsByAddress(getUsdcAddressByChain(savingsChainId))), 2)}
                          </p>
                      ...
                      <div>
                        ...
                        <p className='font-normal text-[#0f0f0f] text-base text-right'>
                          {isWithdrawalTx
                            ? null
                            : `purchase - $${roundOff(formatUnits(BigInt(tx.purchaseValue), getTokenDecimalsByAddress(getUsdcAddressByChain(savingsChainId))), 2)}`}
                        </p>
                      </div>
                    </div>
                  </div>
