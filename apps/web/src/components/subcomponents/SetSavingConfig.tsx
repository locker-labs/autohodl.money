...
export default function SetSavingConfig({
  ...
  return (
    <fieldset
      className=
        "w-full rounded-lg p-6 shadow-smdisabled:opacity-60"
      disabled={disabled}
    >
      {title ? (
      ...
      <div className="flex flex-col gap-6 mt-4">
        ...
        <div className="flex items-center gap-2 pt-6 md:pt-0">
          ...
          <label htmlFor={"toYield"} className="text-sm text-gray-700">
            Yield savings (Earn yield on your savings. Learn more <a href="#" className="text-blue-500">here</a>)
          </label>
        </div>

        {/* Address input */}
        {!toYield && <div className="flex flex-col gap-1">
          <label
            htmlFor={address}
            className="text-xs font-medium text-gray-600"
          >
